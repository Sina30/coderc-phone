        ...
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    ...
                    $.post('http://coderc-phone/GetBankContacts', JSON.stringify({}), function(contacts){
                        QB.Phone.Functions.LoadContactsWithNumber(contacts);
                    });
                    $.post('http://coderc-phone/GetInvoices', JSON.stringify({}), function(invoices){
                    ...
                    $.post('http://coderc-phone/GetMissedCalls', JSON.stringify({}), function(recent){
                        QB.Phone.Functions.SetupRecentCalls(recent);
                    });
                    $.post('http://coderc-phone/GetSuggestedContacts', JSON.stringify({}), function(suggested){
                        QB.Phone.Functions.SetupSuggestedContacts(suggested);
                    });
                    $.post('http://coderc-phone/ClearGeneralAlerts', JSON.stringify({
                        app: "phone"
                    }));
                } else if (PressedApplication == "mail") {
                    $.post('http://coderc-phone/GetMails', JSON.stringify({}), function(mails){
                    ...
                    $.post('http://coderc-phone/LoadAdverts', JSON.stringify({}), function(Adverts){
                        QB.Phone.Functions.RefreshAdverts(Adverts);
                    })
                } else if (PressedApplication == "garage") {
                    $.post('http://coderc-phone/SetupGarageVehicles', JSON.stringify({}), function(Vehicles){
                        SetupGarageVehicles(Vehicles);
                    })
                } else if (PressedApplication == "crypto") {
                    $.post('http://coderc-phone/GetCryptoData', JSON.stringify({
                        crypto: "qbit",
                    }), function(CryptoData){
                        SetupCryptoData(CryptoData);
                    })

                    $.post('http://coderc-phone/GetCryptoTransactions', JSON.stringify({}), function(data){
                    ...
                    $.post('http://coderc-phone/GetPlayerHouses', JSON.stringify({}), function(Houses){
                        SetupPlayerHouses(Houses);
                    });
               } else if (PressedApplication == "taxi") {
                    $.post('http://coderc-phone/GetCurrentDrivers', JSON.stringify({}), function(data){
                        SetupDrivers(data);
                    });			
                } else if (PressedApplication == "mecano") {
                    $.post('http://coderc-phone/GetCurrentMecano', JSON.stringify({}), function(data){
                        SetupMecano(data);
                        //SetupDrivers(data);
                    });	
                } else if (PressedApplication == "doctor") {
                    $.post('http://coderc-phone/GetCurrentDoctor', JSON.stringify({}), function(data){
                        SetupDoctor(data);
                        //SetupDrivers(data);
                    });			
                    ...
                    $.post('http://coderc-phone/GetCurrentLawyers', JSON.stringify({}), function(data){
                        SetupLawyers(data);
                    });
                }  else if (PressedApplication == "polices") {
                    $.post('http://coderc-phone/GetCurrentpolices', JSON.stringify({}), function(data){
                        Setuppolices(data);
                    });					
                } 
            }
...
QB.Phone.Notifications.Add = function(icon, title, text, color, timeout) {
    $.post('http://coderc-phone/HasPhone', JSON.stringify({}), function(HasPhone){
        if (HasPhone) {
